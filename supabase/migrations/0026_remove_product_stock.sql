-- ============================================================================
-- 0022_remove_product_stock
--
-- Stock is not tracked in this release — removes stock_quantity from products
-- and product_variants. Sellability no longer depends on it:
--   * A variant is sellable whenever is_available is true.
--   * A no-variant product is always sellable.
-- Updates refresh_product_read_model() (the has_sellable_variant trigger
-- function) and the save_product RPC accordingly.
-- ============================================================================
