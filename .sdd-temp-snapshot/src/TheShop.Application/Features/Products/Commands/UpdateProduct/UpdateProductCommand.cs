...
/// <summary>
/// Updates an existing product — details, gallery, option types, and generated variants — as
/// one aggregate write. <see cref="RowVersion"/> is the opaque concurrency token the edit form
/// loaded with (Decision 11); a save since then fails with
