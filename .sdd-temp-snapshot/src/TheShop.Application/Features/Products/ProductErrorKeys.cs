...
public static class ProductErrorKeys
{
    ...
    public const string DescriptionUnsupportedContent = "Product_DescriptionUnsupportedContent";
    public const string DescriptionTooLarge = "Product_DescriptionTooLarge";
    public const string SpecificationNameRequired = "Product_SpecificationNameRequired";
    public const string SpecificationValueRequired = "Product_SpecificationValueRequired";
    public const string SpecificationNameDuplicated = "Product_SpecificationNameDuplicated";
