-- ============================================================================
-- 0031_save_product_specifications
--
-- Extends save_product(payload) to persist an ordered set of specification
-- rows in the same transaction: adds their delete-before-insert to the
-- update path and inserts payload->'specifications' in both modes. Nothing
-- else in the function changes. Companion plan: .specs/product-description/plan.md §7 TASK-012
-- ============================================================================
