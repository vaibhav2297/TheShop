...
public class ProductTests
{
    ...
    public void UpdateDetails_WithValidData_UpdatesNameDescriptionCategoryAndBrand()
    {
        ...
        product.UpdateDetails("New Name", "New description.", newCategory, newBrand);
    ...
    public void UpdateDetails_WithBlankName_ThrowsProductNameRequiredException()
    {
        ...
        var act = () => product.UpdateDetails("   ", "desc", ExampleCategory(), ExampleBrand());
    ...
    public void UpdateDetails_WithNameOver150Characters_ThrowsProductNameTooLongException()
    {
        ...
        var act = () => product.UpdateDetails(tooLong, "desc", ExampleCategory(), ExampleBrand());
    ...
    public void UpdateDetails_WithNameOfExactly150Characters_Succeeds()
    {
        ...
        var act = () => product.UpdateDetails(boundary, "desc", ExampleCategory(), ExampleBrand());
    ...
    [Fact]
    [Trait("Feature", "create-product")]
    public void UpdateDetails_WithDescriptionOver2000Characters_ThrowsProductDescriptionTooLongException()
    {
        var product = BuildProduct();
        var tooLong = new string('a', 2001);

        var act = () => product.UpdateDetails("Name", tooLong, ExampleCategory(), ExampleBrand());
    ...
    {
        var product = Product.Create(
            "Elf Bar BC5000", "   ", null, Sku.Create("ELF-BC5000"),
            ProductPricing.Create(Money.Create(24.99m)), true, ExampleCategory(), ExampleBrand());

        product.Description.Should().BeEmpty("an optional description with only whitespace is not entered (RULE-1)");
    }
