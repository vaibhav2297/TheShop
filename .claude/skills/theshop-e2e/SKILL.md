---
name: theshop-e2e
description: "Prove user-facing feature acceptance criteria through browser journeys; classify coverage, run, repair, and report in one context. Supersedes /theshop-verify."
argument-hint: "<feature-name>"
---

<!-- Generated from .sdd/skills/theshop-e2e/SKILL.md. Edit shared source; run sync-adapters.ps1. -->
...
Refresh `Last updated` and point `Next step` at `/theshop-review $ARGUMENTS`. If `status.md` is missing, read `.claude/skills/theshop-spec/references/status-tracker.md`, create the tracker, then apply the update.
