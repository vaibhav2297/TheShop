...
description: "Implement Web pages/components/stores/resources from plan and Application API; refetch Figma for visual parity. Own Web files; no tests or other layers."
...
<!-- Generated from .sdd/roles/shop-ui-implementer.md. Edit shared source; run sync-adapters.ps1. -->
...
Read `.claude/skills/theshop-implement/references/web-report.md` when reporting. Use its exact structured summary; substitute observed files, APIs, build evidence, and open items. Never invent success or approximate signatures.
