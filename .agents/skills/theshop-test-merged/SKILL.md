...
Refresh `Last updated`. If `status.md` is missing, read `.agents/skills/theshop-spec/references/status-tracker.md`, create the standard tracker, then apply the Test update.
