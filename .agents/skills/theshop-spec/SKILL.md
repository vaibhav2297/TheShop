...
Read `.agents/skills/theshop-spec/templates/spec-template.md`; follow exactly, never reconstruct from memory. Remove authoring guidance blockquotes.
...
- **Spec template:** `.agents/skills/theshop-spec/templates/spec-template.md`; required in Step 3.
