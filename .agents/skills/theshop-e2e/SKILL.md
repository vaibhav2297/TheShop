...
Refresh `Last updated` and point `Next step` at `$theshop-review {arguments}`. If `status.md` is missing, read `.agents/skills/theshop-spec/references/status-tracker.md`, create the tracker, then apply the update.
