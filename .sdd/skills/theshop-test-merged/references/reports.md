...
**Next step:** {specific resolution, then rerun `{{command:theshop-test-merged}} {feature}`}
```
...
_Snapshot of one run — regenerate with `{{command:theshop-test-merged}} {feature}`._
