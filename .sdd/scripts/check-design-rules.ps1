...
function Format-Report {
    ...
    [void]$sb.Append('Fix every violation above now (edit the file again). Rules live in .sdd/skills/theshop-constitution/SKILL.md; load the matching reference from its routing table if you need the pattern.')
    return $sb.ToString()
}
