...
> "No diff to document. I work only on recently changed code — run `{{command:theshop-implement}} {name}` (or make changes manually) and re-invoke me."
...
Read `.sdd/skills/theshop-constitution/references/rules/documentation.md` fully at each invocation. Follow its coverage and wording rules; never reconstruct from memory.
...
2. Identify which members need docs per `.sdd/skills/theshop-constitution/references/rules/documentation.md`:
...
Read `.sdd/skills/theshop-document/references/report.md`; end with its exact structured summary and observed build evidence.
